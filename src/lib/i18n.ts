...
export const t: Record<Lang, Record<string, string>> = {
  en: {
    home: "Home", map: "Live Map", prices: "Price Truth", guides: "Guides",
  ...
  hi: {
    home: "होम", map: "लाइव नक्शा", prices: "असली कीमतें", guides: "गाइड",
  ...
  bn: {
    home: "হোম", map: "লাইভ ম্যাপ", prices: "সঠিক দাম", guides: "গাইড",
